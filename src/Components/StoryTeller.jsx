...
Content: "በአንድ ወቅት በጫካ ውስጥ አንበሳ ይኖር ነበር ። አንድ ቀን ከባድ ምግብ ከተመገበ በኋላ። ከዛፍ በታች ተኝቶ ነበር ። ከጥቂት ጊዜ በኋላ አንድ አይጥ መጣና በአንበሳው ላይ መጫወት ጀመረ። በድንገት አንበሳው በቁጣ ተነሳና ጥሩ እንቅልፍ የረበሹትን ሰዎች አየ። ከዚያም አንዲት ትንሽ አይጥ በፍርሃት እየተንቀጠቀጠች ቆማ አየች። አንበሳው ላይ ዘልሎ መግደል ጀመረ። አይጡም አንበሳውን ይቅር እንዲለው ጠየቁት። አንበሳው አዘነና ትቶት ሄደ። አይጧ ሮጠች።በሌላ ቀን ደግሞ አንበሳው በአደን መረብ ተያዘ። አይጧም እዚያ መጥታ መረቡን ቆረጠች። በዚህ መንገድ አመለጠ ። ከዚያ በኋላ አይጧና አንበሳው ጓደኛሞች ሆኑ። ከዚያ በኋላ በጫካ ውስጥ በደስታ ኖረዋል ።"},
{
    ...
    return (
      <div style={styles.container}>
        ...
        <Link to="/" style={styles.backLink}>
          <button style={styles.backButton}>⬅ Back Home</button>
        </Link>
      </div>
    );
  }
    ...
    <div style={styles.container}>
      ...
      {currentStory && (
        <div style={styles.storyCard}>
          ...
          <p style={styles.storyContent}>{currentStory.content}</p>
      ...
      <button onClick={() => setShowForm(!showForm)} style={styles.button}>
        {showForm ? "Close Form" : "Add Your Own Story"}
      </button>
